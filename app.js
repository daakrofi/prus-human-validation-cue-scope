const STORAGE_PREFIX = "prus-post-validation-synthetic-rubric-hybrid-v1";
const SAMPLE_VERSION = "2026-07-18-synthetic-rubric-hybrid-v1";
const DATA_PATH = "data/sample_posts.json?v=20260718-hybrid-v1";
...
function downloadCsv() {
  ...
  download(`prus_post_validation_hybrid_${normalizeEmail(participant.email)}.csv`, csv, "text/csv;charset=utf-8");
}
...
function downloadJson() {
  ...
  download(
    `prus_post_validation_hybrid_${normalizeEmail(participant.email)}.json`,
